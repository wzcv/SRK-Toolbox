...
module.exports = {
    ...
    // testOp(browser, "Shake", "test input", "test_output");
        ...
        //testOpHtml(browser, "在地图上显示", "51.5007° N, 0.1246° W", "#presentedMap .leaflet-popup-content", "51.5007,-0.1246"); //TODO: This works on a real desktop Chrome but not on my test machine, no idea why
